...
// pub fn add_disk(old_board: &Vec<Vec<i64>>, column: usize, value: i64) -> Vec<Vec<i64>> {
...
// }
    ...
    //     if (*current_turn == 42) && (!(*won)) {
    //         win(0);
    //     }
    // };

    // pub fn draw_circle(x: u32, y: u32, color: &str, outline: &str) {
    //     self.canvas_context.as_ref().unwrap().save();
    ...
    // pub fn animate(column: usize, current_turn: i64, to_row: usize, cur_pos: usize, mode: bool) {
    //     let mut fg_color = "transparent";
    //     if current_turn >= 1 {
    //         fg_color = "#ff0000";
    //     } else if current_turn <= -1 {
    ...
    // pub fn player_action(column: usize, mode: bool) -> i64 {
    //     if self.paused || self.won {
    //         return 0;
    //     }
